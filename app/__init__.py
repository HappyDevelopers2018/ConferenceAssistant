...
@app.route('/registerConferencePage', methods=['GET', 'POST'])
def regConf():
...
@app.route('/sons_manage', methods=['GET', 'POST'])
def manageSon():
    return send_file('./templates/sons_manage.html')
...
def messageBox():
    return send_file('./templates/messageBox.html')
